...
public class TerrainChunk
{
    ...
    public TerrainChunk(Vector2 coord, HeightMapSettings heightMapSettings, MeshSettings meshSettings, LODInfo[] detailsLevels, int colliderLODIndex, Transform parent, Transform viewer, Material material)
    {
        this.coord = coord;
        ...
        sampleCentre = coord * meshSettings.meshWorldSize / meshSettings.meshScale; // ensure it is not affected by meshScale -> divide it.
